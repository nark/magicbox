...
ActiveRecord::Schema.define(version: 2021_12_15_091735) do
  ...
  create_table "harvests", force: :cascade do |t|
    t.bigint "grow_id"
    t.float "harvested_trim_weight"
    t.float "harvested_waste_weight"
    t.float "harvested_bud_weight"
    t.float "dry_trim_weight"
    t.float "dry_bud_weight"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false

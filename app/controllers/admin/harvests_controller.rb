class Admin::HarvestsController < Admin::AdminController
  ...
  private
    ...
    def harvest_params
      params.require(:harvest).permit(:grow_id, :harvested_trim_weight, :harvested_waste_weight, :harvested_bud_weight, :dry_trim_weight, :dry_bud_weight)
    end
end
